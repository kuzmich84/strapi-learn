...
export interface ApiBlogPageBlogPage extends Schema.SingleType {
  ...
  attributes: {
    ...
    slug: Attribute.UID<'api::blog-page.blog-page', 'name'>;
...
export interface ApiHeaderHeader extends Schema.SingleType {
  ...
  attributes: {
    ...
    >;
    socialLinks: Attribute.Component<'config.sicial-link', true>;
    shoeProfileLink: Attribute.Boolean &
      Attribute.Required &
...
export interface ApiHomePageHomePage extends Schema.SingleType {
  ...
  attributes: {
    ...
    dynamicHomeSection: Attribute.DynamicZone<['layout.new-letter-form']>;
    seoHomePage: Attribute.Component<'seo.seo-information'>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
